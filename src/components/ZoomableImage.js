//  https://gist.github.com/evgen3188/db996abf89e2105c35091a3807b7311d
/** Links:
...
class ZoomableImage extends Component {
  ...
  processPinch(x1, y1, x2, y2) {
    ...
    this.props.onProcessPinch(this.state);
  }
  ...
  processTouch(x, y) {
    ...
    if (!this.state.isMoving) {
      ...
      this.props.onProcessTouch(this.state);
    }
  }
  ...
  render() {
    ...
    return (
      ...
      <Image style={{
        position: 'absolute',
          top: this.state.offsetTop + top,
          left: this.state.offsetLeft + left,
          width: this.props.imageWidth * zoom,
          height: this.props.imageHeight * zoom,
        }}
